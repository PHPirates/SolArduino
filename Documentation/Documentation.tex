...
\begin{document}
	...
	\section{Maintenance}
		...
		To change IP adress, change it in the Arduino code two times (\verb|myip| en \verb|gw|), in the Android app two times (\verb|ipString| and \verb|host|), and in the desktop app.
